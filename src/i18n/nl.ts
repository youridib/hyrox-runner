...
export const nl: Dict = {
  ...
  stationsTitle: 'Stationtijden',
  stationsHint: 'De stations zijn 40% van de wedstrijd en dragen de meeste spreiding. Vul in wat elk station jou echt kost; wat je niet getest hebt wordt hieronder geschat.',
  stationsFooterHint: 'Tijden gelden voor de wedstrijddosis op wedstrijdgewicht. Hertest elke zes weken - oudere benchmarks krijgen het label verouderd.',
  stationsTestedLabel: (tested, total) => `${tested} van ${total} gemeten`,
  stationTotalLabel: 'Stations totaal',
  requiredFinish: 'Telt op tot je doeltijd',
  goalShort: 'doel',
  fieldShort: 'veld',
  goalOverBy: 'Boven je doeltijd met',
  goalOverrunHint: (pace) =>
    'Je gemeten stations passen niet meer in deze doeltijd. Haal de tijd uit de stations hierboven, loop sneller dan ' + pace + '/km, of geef de doeltijd meer ruimte.',
  estimateFromGoal: 'Ongeteste stations krijgen wat je doeltijd overlaat, nadat de lopen en de roxzone betaald zijn.',
  estimateFromPace: (pace) =>
    `Ongeteste stations zijn geschat vanuit je doeltempo van ${pace}/km. Zet hierboven een doeltijd om juist daarvandaan terug te rekenen.`,
  estimateAllMeasured: 'Alle stations gemeten - dit zijn je eigen cijfers.',
  clearBenchmark: 'Wissen',
  minutesLabel: 'Minuten',
  secondsLabel: 'Seconden',
  goalHoursLabel: 'Uren',
  goalMinutesLabel: 'Minuten',
